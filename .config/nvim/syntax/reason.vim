" From https://github.com/jordwalke/vim-reasonml/blob/master/syntax/reason.vim
" Vim syntax file
...
syn region reasonFoldBraces contained start=/{/  end=/}/ contains=reasionSpreadOperator transparent fold
...
hi def link reasonEscape        Character
